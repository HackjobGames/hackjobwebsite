(function () {
	...
	*/
	...
	var potatoGame = function potatoGame() {
	  return react.createElement("iframe", {
	    frameBorder: "0",
	    src: "https://itch.io/embed-upload/1776960?color=333333",
	    allowFullScreen: true,
	    width: "1000",
	    height: "660"
	  }, react.createElement("a", {
	    href: "https://hackjobgames.itch.io/plant-the-potato"
	  }, "Play Plant The Potato on itch.io"));
	};

	var birdGame = function birdGame() {
	  return react.createElement("iframe", {
	    frameBorder: "0",
	    src: "https://itch.io/embed-upload/1917788?color=333333",
	    allowFullScreen: true,
	    width: "1000",
	    height: "660"
	  }, react.createElement("a", {
	    href: "https://hackjobgames.itch.io/birds-away"
	  }, "Play Birds Away on itch.io"));
	};
	...
	var RenderGame = function RenderGame(options) {
	  var gameContainer = document.getElementById(options.containerName);
	  reactDom.render(options.game(), gameContainer);
	};

	var loadGamesPage = function loadGamesPage() {
	  jquery("#browser").load("./src/html/games.html", function () {
	    jquery("#games_browser").load("./src/html/game_info/landing_page.html");
	    jquery('#bird_button').on('click', function () {
	      jquery("#games_buttons").load('./src/html/game_info/birdsaway/birds_info.html', function () {
	        RenderGame({
	          containerName: 'game_player',
	          game: emptyGame
	        });
	        jquery('#about_birds').on('click', function () {
	          jquery('#info_browser').load('./src/html/game_info/birdsaway/about.html');
	        });
	        jquery('#how_to_birds').on('click', function () {
	          jquery('#info_browser').load('./src/html/game_info/birdsaway/how_to.html');
	        });
	        jquery('#play_birds').on('click', function () {
	          RenderGame({
	            containerName: 'game_player',
	            game: birdGame
	          });
	    ...
	    jquery('#potato_button').on('click', function () {
	      jquery("#games_buttons").load('./src/html/game_info/potato/potato_info.html', function () {
	        RenderGame({
	          containerName: 'game_player',
	          game: emptyGame
	        });
	        jquery('#about_potato').on('click', function () {
	          jquery('#info_browser').load('./src/html/game_info/potato/about.html');
	        });
	        jquery('#how_to_potato').on('click', function () {
	          jquery('#info_browser').load('./src/html/game_info/potato/how_to.html');
	        });
	        jquery('#play_potato').on('click', function () {
	          RenderGame({
	            containerName: 'game_player',
	            game: potatoGame
	          });
	...
	jquery("#browser").load("./src/html/main.html", function () {
	...
	jquery("#main_but").on("click", function () {
	  jquery("#browser").load("./src/html/main.html");
	  jquery(".sidebar").toggleClass("side");
	  jquery(".toggle-button").toggleClass("fa-times");
	});
	jquery("#about_but").on("click", function () {
	  jquery("#browser").load("./src/html/about.html");
	  jquery(".sidebar").toggleClass("side");
	  jquery(".toggle-button").toggleClass("fa-times");
	});
	jquery("#games_but").on("click", function () {
	  loadGamesPage();
	  jquery(".sidebar").toggleClass("side");
	  jquery(".toggle-button").toggleClass("fa-times");
	});
	jquery("#stream_but").on("click", function () {
	  jquery("#browser").load("./src/html/stream.html");
	  jquery(".sidebar").toggleClass("side");
	  jquery(".toggle-button").toggleClass("fa-times");
	});
	jquery(".toggle-button").on("click", function () {
	  jquery(".sidebar").toggleClass("side");
	  jquery(".toggle-button").toggleClass("fa-times");
	  jquery(".body-shift").toggleClass(".body-unshift");
	}); //end_main
	//stream
	...
	var liveCheck = function liveCheck() {
	  var live = document.getElementById('live_img');
	  jquery.ajax({
	    ...
	    error: function error() {//request failed
	    }
	  });
	};
	...
	var getDevlogs = function getDevlogs() {
	  return axios.get('http://hackjob.games:3000', {
	    headers: {
	      request: 'devlogMain'
	    }
	  });
	...
	var devlogReact = function devlogReact() {
